...
* Each scenario must have a unique `Scenario` name (or `Scenario Outline` name) and a unique tag identifier. The recommended format for scenario tag identifier is:
