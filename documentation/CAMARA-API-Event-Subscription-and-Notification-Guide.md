...
- [CAMARA API Event Subscription and Notification Guide](#camara-api-event-subscription-and-notification-guide)
  ...
  - [2. Event Subscription](#2-event-subscription)
    - [2.1. Instance-based (Implicit) Subscription](#21-instance-based-implicit-subscription)
      - [2.1.1. Instance-based (Implicit) Subscription Example](#211-instance-based-implicit-subscription-example)
    - [2.2. Resource-based (Explicit) Subscription](#22-resource-based-explicit-subscription)
      - [2.2.1. Event Subscription Management Operations](#221-event-subscription-management-operations)
      - [2.2.2. Rules for Subscriptions Data Minimization](#222-rules-for-subscriptions-data-minimization)
      - [2.2.3. Subscriptions Data Model](#223-subscriptions-data-model)
      - [2.2.4. Error Definition for Resource-based (Explicit) Subscription](#224-error-definition-for-resource-based-explicit-subscription)
      - [2.2.5. Termination for Resource-based (Explicit) Subscription](#225-termination-for-resource-based-explicit-subscription)
      - [2.2.6. Resource-based (Explicit) Subscription Example](#226-resource-based-explicit-subscription-example)
