...
|       422        |      `MISSING_IDENTIFIER`     | The device cannot be identified.                                           | A device identifier is not included in the request and the device or phone number identification cannot be derived from the access token                                       |
...
|     5      | A device identifier is not included in the request and the device or phone number identification cannot be derived from the access token |       422       |      MISSING_IDENTIFIER      | The device cannot be identified. |
